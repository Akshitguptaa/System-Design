...
These notes continue from [Chapter 2 — Scaling & Estimation](<02 - Scaling & Back-of-the-Envelope Estimation.md>). Every concept is explained from first principles with real-world analogies, diagrams, and worked examples.

**Previous ←** [Chapter 2: Scaling & Estimation](<02 - Scaling & Back-of-the-Envelope Estimation.md>) · **Next →** [Chapter 4: SQL/NoSQL, Microservices & Load Balancing](<04 - Monolithic vs Microservices Architecture.md>)
